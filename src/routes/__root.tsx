...
import { SdfApp } from "@/components/SdfApp";
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Outlet />
      {/* O app legado monta em #root. Ele fica aqui (fora das rotas) para que
          mudanças de URL não desmontem o container e apaguem a tela. */}
      <SdfApp />
    </QueryClientProvider>
  );
}
